...
def fill_gfa_form(
    ...
    user_data_dir = Path.home() / ".project_creator_chrome"
    ...
    with sync_playwright() as p:
        ...
        if context.pages:
            ...
            console.print(f"[dim]DEBUG: No pages in context. Creating new page.[/dim]")
        ...
        # DEBUG: Print all question titles on the form
        try:
